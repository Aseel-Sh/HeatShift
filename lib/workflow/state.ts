...
function invalidateSample(state: WorkflowState): Partial<WorkflowState> {
  ...
  return { isDemo:false, planSource:"manual", forecast:[], forecastSource:"none", weatherStatus:"idle", weatherError:null, conditions:{measurementMode:"forecast",twlZone:"none"}, scheduleResult:null };
}
...
export function workflowReducer(state: WorkflowState, action: WorkflowAction): WorkflowState {
  switch (action.type) {
    ...
    case "applyExtraction": {
      ...
      return {...state,...invalidateSample(state),step:"verify",aiStatus:"idle",aiError:null,planSource:"ai",nextTaskId:next,
    ...
    case "setConditions": return {...state,...(state.isDemo?{isDemo:false,planSource:"manual",forecast:[],forecastSource:"none",weatherStatus:"idle",weatherError:null}:{}),conditions:action.conditions,scheduleResult:null};
    case "weatherLoading": return {...state,weatherStatus:"loading",weatherError:null,forecast:[],forecastSource:"none"};
    case "weatherSuccess": return {...state,weatherStatus:"success",weatherError:null,forecast:action.forecast,forecastSource:"live"};
    case "weatherError": return {...state,weatherStatus:"error",weatherError:action.error,forecast:[],forecastSource:"none"};
