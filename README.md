...
This repository contains the stable project foundation, application shell, validated domain models, deterministic Saudi heat-planning rules, and the pure five-minute scheduling engine. Gemini extraction, weather fetching, and the production planning workflow are intentionally not implemented yet.
...
- `lib/` — validated domain models, pure rules, deterministic scheduler, and future integration boundaries
...
See [Product scope](docs/PRODUCT_SCOPE.md), [Architecture](docs/ARCHITECTURE.md), [Scheduler](docs/SCHEDULER.md), and [Progress](docs/PROGRESS.md).
