...
const copy = {
  en: {
    ...
    dependencies: "Confirmed predecessors",
    afterActivity: "After",
  ...
  ar: {
    ...
    dependencies: "الأنشطة السابقة المؤكدة",
    afterActivity: "بعد",
...
function TaskRow({ state, task, index, t, dispatch }: { state: WorkflowState; task: DraftWorkTask; index: number; t: UiCopy; dispatch: WorkflowDispatch }) {
  ...
  const predecessorOptions = state.tasks.slice(0, index);
